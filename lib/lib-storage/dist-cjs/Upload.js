...
class Upload extends events_1.EventEmitter {
  ...
  async __uploadUsingPut(dataPart) {
    ...
    const resolved = await Promise.all([
      ...
      (_a = clientConfig === null || clientConfig === void 0 ? void 0 : clientConfig.endpoint) === null || _a === void 0
        ? void 0
    ...
    if (!endpoint) {
      endpoint = (0, middleware_endpoint_1.toEndpointV1)(
        await (0, middleware_endpoint_1.getEndpointFromInstructions)(params, client_s3_1.PutObjectCommand, {
          ...clientConfig,
        })
      );
    }
    ...
    const locationKey = this.params.Key.split("/")
  ...
  async __doMultipartUpload() {
    ...
    if (this.tags.length) {
      await this.client.send(
        new client_s3_1.PutObjectTaggingCommand({
          ...this.params,
          Tagging: {
            TagSet: this.tags,
          },
