import { __assign, __asyncValues, __awaiter, __extends, __generator, __values } from "tslib";
...
var Upload = (function (_super) {
  ...
  function Upload(options) {
    ...
    _this.alreadyUploadedParts = options.alreadyUploadedParts || _this.alreadyUploadedParts;
    _this.uploadId = options.previousUploadId || _this.uploadId;
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            ...
            return [
              ...
              Promise.all([
                ...
                (_a = clientConfig === null || clientConfig === void 0 ? void 0 : clientConfig.endpoint) === null ||
                _a === void 0
                  ? void 0
                  : _a.call(clientConfig),
              ]),
            ];
          case 1:
            resolved = _c.sent();
          ...
          case 3:
            ...
            locationKey = this.params.Key.split("/")
            ...
            Location = this.client.config.forcePathStyle
              ? ""
                  .concat(endpoint.protocol, "//")
                  .concat(endpoint.hostname, "/")
                  .concat(locationBucket, "/")
                  .concat(locationKey)
              : ""
                  .concat(endpoint.protocol, "//")
                  .concat(locationBucket, ".")
                ...
                switch (_h.label) {
                  case 0:
                    ...
                    if (this_1.uploadedParts.length > this_1.MAX_PARTS) {
                      throw new Error(
                        "Exceeded "
                          .concat(this_1.MAX_PARTS, " as part of the upload to ")
                          .concat(this_1.params.Key, " and ")
                          .concat(this_1.params.Bucket, ".")
                      );
                    }
                    _h.label = 1;
                  case 1:
                  ...
                  case 5:
                    ...
                    try {
                      for (
                        _d = ((e_3 = void 0), __values(this_1.alreadyUploadedParts)), _e = _d.next();
                        !_e.done;
                        _e = _d.next()
                      ) {
                        (_f = _e.value), (alreadyUploadedPartNumber = _f.PartNumber), (alreadyUploadedETag = _f.ETag);
                        if (alreadyUploadedPartNumber === dataPart.partNumber) {
                          this_1.bytesUploadedSoFar += partSize_1;
                          this_1.uploadedParts.push({
                            PartNumber: alreadyUploadedPartNumber,
                            ETag: alreadyUploadedETag,
                          });
                          return [2, "continue-dataFeederLoop"];
                        }
                      }
                    } catch (e_3_1) {
                      e_3 = { error: e_3_1 };
                    ...
                    return [
                      ...
                      this_1.client.send(
                        new UploadPartCommand(
                          __assign(__assign({}, this_1.params), {
                            UploadId: this_1.uploadId,
                            Body: dataPart.data,
                  ...
                  case 6:
                    ...
                    if (!partResult.ETag) {
                      throw new Error(
                        "Part ".concat(
                          dataPart.partNumber,
                          " is missing ETag in UploadPart response. Missing Bucket CORS configuration for ETag header?"
                        )
                      );
                    }
                    this_1.uploadedParts.push(
  ...
  Upload.prototype.__validateInput = function () {
    ...
    if (this.partSize < MIN_PART_SIZE) {
      throw new Error(
        "EntityTooSmall: Your proposed upload partsize ["
          .concat(this.partSize, "] is smaller than the minimum allowed size [")
          .concat(MIN_PART_SIZE, "] (5MB)")
      );
    }
    if (this.queueSize < 1) {
